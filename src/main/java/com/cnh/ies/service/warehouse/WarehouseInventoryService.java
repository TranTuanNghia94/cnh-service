...
public class WarehouseInventoryService {
    ...
    /**
     * After an inbound receipt is fully approved, add received quantities to inventory and write INBOUND ledger rows (idempotent).
     */
    @Transactional
    ...
    public WarehouseStockTransactionInfo recordOutbound(WarehouseOutboundRequest request, String requestId) {
        ...
        WarehouseInventoryEntity inv = warehouseInventoryRepo.findByProductId(pid)
                .orElseThrow(() -> new ApiException(ApiException.ErrorCode.BAD_REQUEST, "No inventory record for product",
                        HttpStatus.BAD_REQUEST.value(), requestId));
    ...
    private WarehouseStockTransactionEntity saveTransaction(ProductEntity product, String direction, BigDecimal quantity,
